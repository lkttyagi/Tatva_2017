...
$(".readMore").click(function(){
	...
	$(".readToggle").toggleClass("hide");
	$(".showLess").toggleClass("show");
});
$(".loadSpeaker").click(function(){
    $(".speakerHide").slideToggle("slow");
	$(".readToggle").toggleClass("hide");
	$(".showLess").toggleClass("show");
});
$(".loadPastSpeaker").click(function(){
    $(".pastSpeakerHide").slideToggle("slow");
	$(".pastReadToggle").toggleClass("hide");
	$(".pastShowLess").toggleClass("show");
});
$(".workshop").click(function(){
    $(".workshop-open").slideToggle("slow");
	$(".readToggle2").toggleClass("hide");
	$(".showLess2").toggleClass("show");
});



$(".readMoreRedirect").click(function(){
    $(".sk-folding-cube").fadeIn();
	$(".readMoreRedirect").hide();
	window.setTimeout(function() {window.location.href = '../about.html';},2000);
});
$(".viewAll").click(function(){
    $(".sk-folding-cube").fadeIn();
	$(".viewAll").hide();
	window.setTimeout(function() {window.location.href = '../sponsors.html';},2000);
});
